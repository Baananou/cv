			...
			images: [
				{
					...
					path: "/thumb1.jpg",
					icons: [
						<TbBrandReactNative key={1} size={24} />,
						<TbBrandFirebase key={1} size={24} />,
						<SiExpo key={1} size={24} />,
					],
				...
				},
				{
					...
					path: "/thumb2.jpg",
					icons: [
						<SiFlutter key={1} size={24} />,
						<SiDart key={1} size={24} />,
					],
...
import { SiDart, SiExpo, SiFlutter } from "react-icons/si";
										...
										<a target="_blank" rel="noopener noreferrer">
											<div className="flex items-center justify-center relative overflow-hidden group">
												...
												<div className="absolute bottom-0 translate-y-full group-hover:-translate-y-10 group-hover:xl:-translate-y-20 transition-all duration-300">
													...
													<div className="flex flex-row gap-9 mt-5 justify-center items-center">
														{image.icons}
													</div>
												</div>
											</div>
