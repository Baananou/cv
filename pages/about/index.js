				...
				<div className="container mx-auto h-full flex flex-col items-center xl:flex-row gap-x-6 overflow-y-auto scrollbar-none">
					<div className="flex-1 flex flex-col justify-center">
						<motion.div
							...
							Transformer{" "}
							<span className="text-accent font-bold"> les rêves</span> en
							réalité numérique.
						</motion.div>
						<motion.p
							variants={fadeIn("right", 0, 2)}
							...
							développement avec une passion inextinguible, cherchant
							constamment à transformer des idées en réalité.
						</motion.p>
